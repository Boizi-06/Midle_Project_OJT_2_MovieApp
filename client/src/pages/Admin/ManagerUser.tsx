...
import "../../css/Admin/ManagerUser.scss";
...
const ManagerUser: React.FC = () => {
  ...
  const handleBlock = (id: number) => {
    axios.patch(`http://localhost:8080/users/${id}`, { status: "bị khóa" });
    setUsers((prev) =>
  ...
  const handleUnblock = (id: number) => {
    axios.patch(`http://localhost:8080/users/${id}`, { status: "hoạt động" });
    setUsers((prev) =>
      ...
      <Sider width={220} className="manager-user__sider">
        <div className="sidebar-menu">
          ...
          <Link to="" className="menu-item">
            ...
            <span onClick={handleCreateAdmin}>Manage News</span>
          </Link>
